    ...
    <div class="bg-surface rounded-card border border-border shadow-sm overflow-hidden">
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-border">
                <thead>
                    <tr class="bg-gray-50">
                        <th class="px-6 py-3 text-left text-xs font-medium text-muted uppercase tracking-wider">No. Rekomendasi</th>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-muted uppercase tracking-wider">Tgl Diunggah</th>
