<x-app-layout>
    ...
    <div class="bg-surface rounded-layout p-6 shadow-sm border border-border">
        <div class="mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
                <h3 class="text-lg font-bold text-ink">Direktori Perangkat Desa Kabupaten</h3>
            ...
            <form action="{{ route('admin.perangkat.index') }}" method="GET" class="w-full md:w-72">
                <div class="relative mt-2 rounded-md shadow-sm">
                    ...
                    <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari nama, jabatan..."
                        class="block w-full rounded-md border-0 py-2 pl-9 pr-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6">
                </div>
            </form>
        </div>
