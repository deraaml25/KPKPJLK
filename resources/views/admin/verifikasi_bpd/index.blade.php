<x-app-layout>
    @section('title', 'Verifikasi Data BPD')

    <div class="bg-white rounded-card p-6 shadow-sm border border-border mb-6">
        <h2 class="text-xl font-display font-bold text-ink">Verifikasi Perubahan Data BPD</h2>
        <p class="text-muted text-sm mt-1">Daftar usulan penambahan, pengubahan, dan penonaktifan data BPD dari desa.</p>
    </div>
