                ...
                <div class="divide-y divide-border">
                    ...
                    <div class="p-6 hover:bg-gray-50 transition-colors flex items-center justify-between">
                        <div class="flex items-center gap-4">
                            <div class="w-10 h-10 rounded-full bg-primary-soft flex items-center justify-center text-primary font-bold">
                                K
                            </div>
                            <div>
                                <h4 class="font-semibold text-ink">Desa Karangendep</h4>
                                <div class="flex items-center gap-2 mt-1">
                                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-primary-soft text-primary">
                                        Pengangkatan
                                    </span>
                        ...
                        <div class="text-right">
                            <p class="text-sm font-medium text-ink">Tahap 4: Paraf Kabid PDPD</p>
                    ...
                    <div class="p-6 hover:bg-gray-50 transition-colors flex items-center justify-between">
                        <div class="flex items-center gap-4">
                            <div class="w-10 h-10 rounded-full bg-red-100 flex items-center justify-center text-danger font-bold">
                                S
                            </div>
                            <div>
                                <h4 class="font-semibold text-ink">Desa Sumbang</h4>
                                <div class="flex items-center gap-2 mt-1">
                                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-red-100 text-danger">
                                        Pemberhentian
                                    </span>
