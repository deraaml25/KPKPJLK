...
@php
    $tahapList = [
        ...
        4 => 'Paraf Kabid PDPD',
        5 => 'Paraf Sekretaris Dinas',
        6 => 'Paraf Asisten Pemerintahan & Kesra',
        7 => 'Paraf Sekda',
        8 => 'Tanda Tangan Bupati',
        9 => 'Penomoran TU Umum Setda & Selesai'
    ];
@endphp
    ...
    <div class="space-y-6 relative z-10">
        @foreach($tahapList as $index => $namaTahap)
            @php
                ...
                if ($index < $tahapAktif) $status = 'selesai';
                if ($index == $tahapAktif) $status = 'aktif';
            ...
            <div class="flex items-start">
                <div class="flex-shrink-0 mt-0.5">
                    ...
                    @elseif($status === 'aktif')
                        <div class="w-12 h-12 rounded-full bg-white border-4 border-primary shadow-sm flex items-center justify-center relative">
                ...
                <div class="ml-4 mt-1.5 flex-1 pb-2">
                    ...
                    @if($status === 'aktif')
                        <span class="inline-block mt-1 text-xs font-medium text-primary bg-primary-soft px-2 py-0.5 rounded-full">Sedang Berjalan</span>
                    @endif
                    ...
                    @if($milestoneData && $milestoneData['catatan'])
                        <div class="mt-2 p-3 bg-gray-50 rounded-md border border-border text-sm text-ink relative">
                            <div class="absolute -left-1.5 top-3 w-3 h-3 bg-gray-50 border-l border-b border-border transform rotate-45"></div>
