...
<?php $component->withAttributes([]); ?>
    <?php $__env->startSection('title', 'Dashboard Desa'); ?>
    ...
    <div
        ...
        <div class="relative z-10">
            <h2 class="text-2xl font-display font-bold mb-2">Selamat Datang, <?php echo e(auth()->user()->name); ?>!</h2>
            ...
            <a href="<?php echo e(route('desa.ajuan.create')); ?>"
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <a href="<?php echo e(route('desa.ajuan.index')); ?>" class="bg-surface rounded-xl border border-border hover:border-ink p-6 shadow-sm transition-all hover:shadow-md flex items-center gap-4 relative overflow-hidden group">
            ...
            <div class="flex-grow">
                ...
                <h3 class="text-3xl font-bold text-ink font-display leading-none"><?php echo e($totalAjuan); ?></h3>
            </div>
        ...
        <a href="<?php echo e(route('desa.ajuan.index', ['status' => 'proses'])); ?>" class="bg-surface rounded-xl border border-border hover:border-ink p-6 shadow-sm transition-all hover:shadow-md flex items-center gap-4 relative overflow-hidden group">
            ...
            <div class="flex-grow">
                ...
                <h3 class="text-3xl font-bold text-ink font-display leading-none"><?php echo e($sedangDiproses); ?></h3>
            </div>
            <div class="absolute right-4 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity translate-x-2 group-hover:translate-x-0 duration-300">
                <svg class="w-6 h-6 text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
        ...
        <a href="<?php echo e(route('desa.ajuan.index', ['status' => 'revisi'])); ?>" class="bg-surface rounded-xl border border-border hover:border-ink p-6 shadow-sm transition-all hover:shadow-md flex items-center gap-4 relative overflow-hidden group">
            ...
            <div class="flex-grow">
                ...
                <h3 class="text-3xl font-bold text-danger font-display leading-none"><?php echo e($perluTindakan); ?></h3>
            </div>
            <div class="absolute right-4 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity translate-x-2 group-hover:translate-x-0 duration-300">
                <svg class="w-6 h-6 text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $ajuans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ajuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-mono text-ink font-medium">
                                <?php echo e($ajuan->no_registrasi); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($badgeColor); ?>">
                                    <?php echo e(optional($ajuan->jenisLayanan)->nama ?? '-'); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-ink font-medium">
                                    ...
                                    <?php if($ajuan->pesertas->count() > 1): ?> <span class="text-primary font-bold">(+<?php echo e($ajuan->pesertas->count() - 1); ?>)</span> <?php endif; ?>
                                </div>
                                <div class="text-xs text-muted"><?php echo e($ajuan->pesertas->first() ? $ajuan->pesertas->first()->perangkatDesa->jabatan : '-'); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <?php if($ajuan->status === 'draft'): ?>
                                    <div class="text-sm text-muted font-medium">Bisa Diajukan</div>
                                    <div class="text-xs text-muted">Berkas Disiapkan</div>
                                <?php elseif($ajuan->status === 'revisi'): ?>
                                    <div class="text-sm text-danger font-medium">Perlu Revisi</div>
                                    <div class="text-xs text-danger">Mohon lengkapi berkas kurang</div>
                                <?php elseif($ajuan->status === 'selesai'): ?>
                                    <div class="text-sm text-success font-medium">Selesai</div>
                                    <div class="text-xs text-success">SK Bupati Terbit</div>
                                <?php else: ?>
                                    <div class="text-sm text-ink font-medium">Tahap <?php echo e($ajuan->milestoneTrackings->where('tgl_selesai', null)->min('tahap') ?: 1); ?> / 4</div>
                                    <div class="text-xs text-warning">Sedang diproses</div>
                                <?php endif; ?>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <?php if($ajuan->status === 'revisi'): ?>
                                    <a href="<?php echo e(route('desa.ajuan.show', $ajuan)); ?>"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.empty-state','data' => ['icon' => '<path stroke-linecap=\'round\' stroke-linejoin=\'round\' d=\'M8 7v8a2 2 0 002 2h6M8 7V5a2 2 0 012-2h4.586a1 1 0 01.707.293l4.414 4.414a1 1 0 01.293.707V15a2 2 0 01-2 2h-2M8 7H6a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2v-2\' />','title' => 'Belum Ada Ajuan Aktif','message' => 'Anda belum memiliki pengajuan rekomendasi yang sedang berproses.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['icon' => '<path stroke-linecap=\'round\' stroke-linejoin=\'round\' d=\'M8 7v8a2 2 0 002 2h6M8 7V5a2 2 0 012-2h4.586a1 1 0 01.707.293l4.414 4.414a1 1 0 01.293.707V15a2 2 0 01-2 2h-2M8 7H6a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2v-2\' />','title' => 'Belum Ada Ajuan Aktif','message' => 'Anda belum memiliki pengajuan rekomendasi yang sedang berproses.']); ?>
        ...
        <div class="flex flex-col gap-6 md:col-span-1">
            ...
            <div class="bg-surface rounded-2xl border border-border shadow-sm overflow-hidden flex flex-col">
                <div class="px-5 py-4 border-b border-border bg-gray-50 flex justify-between items-center">
                    ...
                    <a href="https://www.google.com/maps/search/?api=1&query=Desa+<?php echo e(urlencode(auth()->user()->desa->nama_desa ?? '')); ?>,+Kecamatan+<?php echo e(urlencode(auth()->user()->desa->kecamatan->nama_kecamatan ?? '')); ?>" target="_blank" class="text-xs text-primary font-medium hover:underline">Buka Penuh</a>
                </div>
                <div class="w-full h-48 bg-gray-100 relative">
                    <iframe 
                        ...
                        marginheight="0" 
                        marginwidth="0" 
                        src="https://maps.google.com/maps?q=Desa+<?php echo e(urlencode(auth()->user()->desa->nama_desa ?? '')); ?>,+Kecamatan+<?php echo e(urlencode(auth()->user()->desa->kecamatan->nama_kecamatan ?? '')); ?>&t=k&z=15&ie=UTF8&iwloc=&output=embed"
                ...
                <div class="p-4 bg-white">
                    <div class="flex items-start gap-2">
                        ...
                        <div>
                            <p class="text-sm font-bold text-ink">Desa <?php echo e(auth()->user()->desa->nama_desa ?? '-'); ?></p>
                            <p class="text-xs text-muted">Kec. <?php echo e(auth()->user()->desa->kecamatan->nama_kecamatan ?? '-'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-primary rounded-2xl p-6 text-white shadow-sm flex-1 flex flex-col justify-center relative overflow-hidden group">
                ...
                <div class="relative z-10">
                    ...
                    <a href="<?php echo e(route('desa.bimtek-informasi.index')); ?>" class="inline-flex items-center px-4 py-2 bg-white/20 hover:bg-white/30 rounded-lg text-sm font-semibold transition-colors backdrop-blur-sm">
                        Lihat Pengumuman
...
<?php endif; ?><?php /**PATH C:\laragon\www\sidmini\resources\views/desa/dashboard.blade.php ENDPATH**/ ?>