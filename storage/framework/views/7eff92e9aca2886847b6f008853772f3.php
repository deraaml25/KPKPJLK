...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['tahapAktif' => 1, 'milestones' => [], 'ajuan' => null]));
...
foreach (array_filter((['tahapAktif' => 1, 'milestones' => [], 'ajuan' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
        ...
        <?php $__currentLoopData = $tahapList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $namaTahap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="flex items-start">
                ...
                <div class="ml-4 mt-1.5 flex-1 pb-2">
                    <h4 class="text-sm font-semibold <?php echo e($status === 'belum' ? 'text-muted' : 'text-ink'); ?>">
...
</div><?php /**PATH C:\laragon\www\sidmini\resources\views/components/milestone-tracker.blade.php ENDPATH**/ ?>