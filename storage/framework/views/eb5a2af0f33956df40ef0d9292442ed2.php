...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo e(config('app.name', 'SIDmini')); ?> - <?php echo $__env->yieldContent('title', 'Dashboard'); ?></title>
            ...
            <div class="relative z-10 flex flex-col h-full">
                ...
                <div class="flex items-center h-[72px] border-b border-white/10 bg-black/10 relative">
                    <div class="w-[60px] flex-shrink-0 flex justify-center items-center">
                        <img src="<?php echo e(asset('logo.png')); ?>" onerror="this.src='https://lh3.googleusercontent.com/aida-public/AB6AXuDKBYY88kZ13swAXZCwTS6ub06DYmk7LgIvWrsJg4M5Mf764XFIciikJ_cuC39VrLn_VfTYs_HVED5VotHHKbdrPkVC9ZxMCk27gHWU2YHiYe1RguIfp1OfWuNAnoKAFkHh9p2cYiVxg-LNb09DpG2Pndv5ZtWWTy7W5rcPBE5qYyBjBfMS8eLV8wYS0VZ9sXduv8_vi7bSuXA4QGHHnSYxzVjt3Th6UicoO9-auMC89VtIMDJ4YkYG-qvLrLDMaAo85-DohAodwHVQ'" alt="Logo" class="w-8 h-8 object-contain">
                    </div>
                ...
                <nav class="flex-1 overflow-y-auto scrollbar-none pt-2 flex flex-col w-full">
                    ...
                    <?php else: ?>
                        <?php echo $__env->make('layouts.partials.desa-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <?php endif; ?>
                </nav>
                ...
                <div class="mt-auto flex w-full py-4 border-t border-white/10 bg-black/10 relative">
                    ...
                    <div class="flex-grow px-4 flex flex-col justify-center overflow-hidden">
                        <h3 class="text-white font-bold text-xs truncate"><?php echo e(auth()->user()->name); ?></h3>
                        <p class="text-slate-400 text-[9px] uppercase font-semibold tracking-wide truncate mt-0.5">
                            <?php echo e(auth()->user()->role == 'super_admin' ? 'Administrator' : 'Operator Desa'); ?>

                        </p>

                        <div class="flex flex-col gap-2 mt-2.5">
                            <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center gap-2 text-slate-400 hover:text-white transition-colors text-[11px] font-semibold w-full">
        ...
        <div class="flex-1 flex flex-col relative z-10 overflow-hidden bg-[#f8fafc]">
            ...
            <div class="sticky top-0 z-40 px-6 pt-5 pb-2 bg-[#f8fafc]">
                <div class="flex items-center gap-3">
                    <?php if (! empty(trim($__env->yieldContent('back-button')))): ?>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex flex-col">
                                <span class="text-[9px] font-bold text-slate-400 uppercase tracking-wider mb-0.5">
                                    <?php echo $__env->yieldContent('page-kicker', 'Utama'); ?>
                                </span>
                                ...
                                <p class="text-[13px] text-slate-500 mt-1 font-medium"><?php echo $__env->yieldContent('page-subtitle'); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
