...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['posisiAktif' => 'Berkas Diterima', 'status' => 'draft', 'pjkades' => null]));
...
foreach (array_filter((['posisiAktif' => 'Berkas Diterima', 'status' => 'draft', 'pjkades' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div class="relative py-4">
    ...
    <div class="space-y-6 relative z-10">
        <?php $__currentLoopData = $tahapList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $namaTahap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
                ...
                <div class="flex-shrink-0 mt-0.5">
                    ...
                    <?php else: ?>
                        <div class="w-12 h-12 rounded-full bg-white border-4 border-border flex items-center justify-center">
                            <span class="text-muted font-medium"><?php echo e($index); ?></span>
                        </div>
                    <?php endif; ?>
                </div>

                <div class="ml-4 mt-1.5 flex-1 pb-2">
                    <h4 class="text-sm font-semibold <?php echo e($statusStep === 'belum' ? 'text-muted' : 'text-ink'); ?>">
                        <?php echo e($namaTahap); ?>

                    </h4>

                    <?php if($statusStep === 'aktif'): ?>
                        <span
                            class="inline-block mt-1 text-xs font-medium text-primary bg-primary-soft px-2 py-0.5 rounded-full">Sedang
                            Berjalan</span>
                    <?php endif; ?>

                    <?php if($dateToDisplay): ?>
                        <div class="mt-1 text-xs text-muted flex items-center">
                            ...
                            <?php echo e(\Carbon\Carbon::parse($dateToDisplay)->format('d M Y')); ?>
...
<?php /**PATH C:\laragon\www\sidmini\resources\views/components/pjkades-tracker.blade.php ENDPATH**/ ?>